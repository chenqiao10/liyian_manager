package com.yijie.manager.client.utils;
...
public final class POIWriteSoftLog {
	/**
	 * @POI生成Excel
	 * @param fileName 文件名
	 * @param list     数据集合
	 ...
	 * @throws Exception
	 */
	public static HSSFWorkbook writeExcal(String fileName, List<Object> list, String[] fileHead) throws Exception {
		...
		for (int i = 0; i < list.size(); i++) {
			try {
				...
				// 循环遍历单个对象里的属性
				// 经过特殊调整，安全日志唯一用
				for (int c = 1; c < fields.length-1; c++) {
